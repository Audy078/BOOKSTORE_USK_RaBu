...
if (isset($_POST['register'])) {
    ...
    $query = mysqli_query(
        $conn,
        "INSERT INTO users (nama, no_telp, alamat, email, password)
            ...
            <div class="col-12 card-wrap">
                ...
                <div class="card shadow-sm">
                    <div class="card-header text-white text-center py-3">
                        <h5 class="mb-0">Registrasi User</h5>
                    </div>

                    <div class="card-body">

                        <?php if ($successMsg !== '') { ?>
                            <div class="alert alert-success text-center py-2"><?php echo htmlspecialchars($successMsg); ?></div>
                        <?php } ?>

                        <?php if ($errorMsg !== '') { ?>
                            <div class="alert alert-danger text-center py-2"><?php echo htmlspecialchars($errorMsg); ?></div>
                        <?php } ?>
                        ...
                        <!-- ===== LOGIN LINK (DISAMAKAN DENGAN HALAMAN LOGIN) ===== -->
                        <hr>
                        <p class="text-center mb-0">
                            Sudah punya akun?
                            <a href="login.php" class="fw-semibold text-brand text-decoration-none">
                                Login di sini
                            </a>
                        </p>
